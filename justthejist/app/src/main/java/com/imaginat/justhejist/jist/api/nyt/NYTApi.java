...
public class NYTApi {
  ...
  private static final String API_KEY = "56fdb568f4650663376b28f5493fa58d:5:71410972";
  ...
  public static String getSectionURL(String section) {
    // NOTE(boloutaredoubeni): This whole section is just so we don't mess up, it should be removed later or put into a test
    if (section == null || section.isEmpty()) {
      // don't pass empty or null strings
      throw new IllegalArgumentException("Passed an empty or null section name");
    }
